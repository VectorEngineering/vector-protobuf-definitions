...
type IOrganizationORMDo interface {
	...
	CreateInBatch(items []lead_scraper_servicev1.OrganizationORM, batchSize int) (err error)
...
func (o organizationORMDo) CreateInBatch(items []lead_scraper_servicev1.OrganizationORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO organizations (columns) VALUES (values...) ")

	var executeSQL *gorm.DB
	executeSQL = o.UnderlyingDB().Exec(generateSQL.String()) // ignore_security_alert
	err = executeSQL.Error
...
//
// {{end}}
func (o organizationORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
