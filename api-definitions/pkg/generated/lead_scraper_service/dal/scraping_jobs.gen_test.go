...
func Test_scrapingJobORMQuery(t *testing.T) {
	...
	if err != nil {
		t.Error("clean table <scraping_jobs> fail:", err)
		return
	}
	...
	if err != nil {
		t.Error("create item in table <scraping_jobs> fail:", err)
	}
	...
	if err != nil {
		t.Error("Take() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.First()
	if err != nil {
		t.Error("First() on table <scraping_jobs> fail:", err)
	}
	...
	if err != nil {
		t.Error("FindInBatch() on table <scraping_jobs> fail:", err)
	}
	...
	if err != nil {
		t.Error("FindInBatches() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Select(scrapingJobORM.ALL).Where(primaryKey.IsNotNull()).Order(primaryKey.Desc()).Find()
	if err != nil {
		t.Error("Find() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Distinct(primaryKey).Take()
	if err != nil {
		t.Error("select Distinct() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Select(scrapingJobORM.ALL).Omit(primaryKey).Take()
	if err != nil {
		t.Error("Omit() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Group(primaryKey).Find()
	if err != nil {
		t.Error("Group() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Scopes(func(dao gen.Dao) gen.Dao { return dao.Where(primaryKey.IsNotNull()) }).Find()
	if err != nil {
		t.Error("Scopes() on table <scraping_jobs> fail:", err)
	}

	_, _, err = _do.FindByPage(0, 1)
	if err != nil {
		t.Error("FindByPage() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.ScanByPage(&lead_scraper_servicev1.ScrapingJobORM{}, 0, 1)
	if err != nil {
		t.Error("ScanByPage() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Attrs(primaryKey).Assign(primaryKey).FirstOrInit()
	if err != nil {
		t.Error("FirstOrInit() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Attrs(primaryKey).Assign(primaryKey).FirstOrCreate()
	if err != nil {
		t.Error("FirstOrCreate() on table <scraping_jobs> fail:", err)
	}
	...
	if err != nil {
		t.Error("Join() on table <scraping_jobs> fail:", err)
	}

	err = _do.LeftJoin(&_a, primaryKey.EqCol(_aPK)).Scan(map[string]interface{}{})
	if err != nil {
		t.Error("LeftJoin() on table <scraping_jobs> fail:", err)
	}

	_, err = _do.Not().Or().Clauses().Take()
	if err != nil {
		t.Error("Not/Or/Clauses on table <scraping_jobs> fail:", err)
	}
}
...
var ScrapingJobORMCreateInBatchTestCase = []TestCase{}

func Test_scrapingJobORM_CreateInBatch(t *testing.T) {
	scrapingJobORM := newScrapingJobORM(_gen_test_db)
	do := scrapingJobORM.WithContext(context.Background()).Debug()

	for i, tt := range ScrapingJobORMCreateInBatchTestCase {
		t.Run("CreateInBatch_"+strconv.Itoa(i), func(t *testing.T) {
			res1 := do.CreateInBatch(tt.Input.Args[0].([]lead_scraper_servicev1.ScrapingJobORM), tt.Input.Args[1].(int))
