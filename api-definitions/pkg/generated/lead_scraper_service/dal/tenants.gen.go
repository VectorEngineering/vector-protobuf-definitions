...
type ITenantORMDo interface {
	...
	CreateInBatch(items []lead_scraper_servicev1.TenantORM, batchSize int) (err error)
...
func (t tenantORMDo) CreateInBatch(items []lead_scraper_servicev1.TenantORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO tenants (columns) VALUES (values...) ")
...
//
// {{end}}
func (t tenantORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
