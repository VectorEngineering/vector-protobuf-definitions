...
type IWebhookConfigORMDo interface {
	...
	CreateInBatch(items []lead_scraper_servicev1.WebhookConfigORM, batchSize int) (err error)
...
func (w webhookConfigORMDo) CreateInBatch(items []lead_scraper_servicev1.WebhookConfigORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO webhook_configs (columns) VALUES (values...) ")
...
//
// {{end}}
func (w webhookConfigORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
