...
func (m *Organization) ToORM(ctx context.Context) (OrganizationORM, error) {
	...
	to.Status = Organization_Status_name[int32(m.Status)]
...
func (m *OrganizationORM) ToPB(ctx context.Context) (Organization, error) {
	...
	to.CreatedBy = m.CreatedBy
	to.Status = Organization_Status(Organization_Status_value[m.Status])
...
type TenantORM struct {
	...
	Name                 string
	Organization         *OrganizationORM `gorm:"foreignKey:OrganizationId;references:Id"`
...
func (m *Tenant) ToORM(ctx context.Context) (TenantORM, error) {
	...
	to.Status = Tenant_Status_name[int32(m.Status)]
...
func (m *TenantORM) ToPB(ctx context.Context) (Tenant, error) {
	...
	to.Status = Tenant_Status(Tenant_Status_value[m.Status])
	...
	for i, f := range updateMask.Paths {
		...
		if !updatedOrganization && strings.HasPrefix(f, prefix+"Organization.") {
			...
			if patchee.Organization == nil {
				patchee.Organization = &Organization{}
			}
			if o, err := DefaultApplyFieldMaskOrganization(ctx, patchee.Organization, patcher.Organization, &field_mask.FieldMask{Paths: updateMask.Paths[i:]}, prefix+"Organization.", db); err != nil {
				return nil, err
			} else {
...
func DefaultCreateWorkspace(ctx context.Context, in *Workspace, db *gorm.DB) (*Workspace, error) {
	...
	if err = db.Omit().Preload("ApiKeys").Preload("ScrapingJobs").Preload("Webhooks").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateScrapingWorkflow(ctx context.Context, in *ScrapingWorkflow, db *gorm.DB) (*ScrapingWorkflow, error) {
	...
	*filterJobs.ScrapingWorkflowId = ormObj.Id
	...
	if err = db.Omit().Preload("ApiKeys").Preload("ScrapingJobs").Preload("Webhooks").Save(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultCreateLead(ctx context.Context, in *Lead, db *gorm.DB) (*Lead, error) {
	...
	if err = db.Omit().Preload("ScrapingJobs").Preload("Webhooks").Preload("ApiKeys").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultCreateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("Settings").Preload("Workspaces").Preload("ApiKeys").Preload("ScrapingJobs").Preload("Webhooks").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("Settings").Preload("Workspaces").Preload("ApiKeys").Preload("ScrapingJobs").Preload("Webhooks").Save(&ormObj).Error; err != nil {
		return nil, err
	}
