...
func DefaultCreateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("ScrapingJobs").Preload("ApiKeys").Preload("Webhooks").Preload("Workspaces").Preload("Settings").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("Settings").Preload("Workspaces").Preload("ScrapingJobs").Preload("ApiKeys").Preload("Webhooks").Save(&ormObj).Error; err != nil {
		return nil, err
	}
