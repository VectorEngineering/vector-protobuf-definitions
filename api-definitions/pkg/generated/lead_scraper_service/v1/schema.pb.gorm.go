...
func DefaultCreateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("Webhooks").Preload("ScrapingJobs").Preload("ApiKeys").Preload("Workspaces").Preload("Settings").Create(&ormObj).Error; err != nil {
		return nil, err
	}
...
func DefaultStrictUpdateAPIKey(ctx context.Context, in *APIKey, db *gorm.DB) (*APIKey, error) {
	...
	if err = db.Omit().Preload("Webhooks").Preload("ScrapingJobs").Preload("ApiKeys").Preload("Workspaces").Preload("Settings").Save(&ormObj).Error; err != nil {
		return nil, err
	}
