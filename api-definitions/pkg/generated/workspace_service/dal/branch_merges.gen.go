...
type IBranchMergeORMDo interface {
	...
	CreateInBatch(items []workspace_servicev1.BranchMergeORM, batchSize int) (err error)
...
func (b branchMergeORMDo) CreateInBatch(items []workspace_servicev1.BranchMergeORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO branch_merges (columns) VALUES (values...) ")
...
//
// {{end}}
func (b branchMergeORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
