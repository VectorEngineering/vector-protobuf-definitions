...
type IFolderMetadataORMDo interface {
	...
	CreateInBatch(items []workspace_servicev1.FolderMetadataORM, batchSize int) (err error)
...
func (f folderMetadataORMDo) CreateInBatch(items []workspace_servicev1.FolderMetadataORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO folders (columns) VALUES (values...) ")
...
//
// {{end}}
func (f folderMetadataORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
