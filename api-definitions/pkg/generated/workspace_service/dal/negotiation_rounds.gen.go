...
type INegotiationRoundORMDo interface {
	...
	CreateInBatch(items []workspace_servicev1.NegotiationRoundORM, batchSize int) (err error)
...
func (n negotiationRoundORMDo) CreateInBatch(items []workspace_servicev1.NegotiationRoundORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO negotiation_rounds (columns) VALUES (values...) ")
...
//
// {{end}}
func (n negotiationRoundORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
