...
type ISignatureWorkflowORMDo interface {
	...
	CreateInBatch(items []workspace_servicev1.SignatureWorkflowORM, batchSize int) (err error)
...
func (s signatureWorkflowORMDo) CreateInBatch(items []workspace_servicev1.SignatureWorkflowORM, batchSize int) (err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("INSERT INTO signature_workflows (columns) VALUES (values...) ")
...
//
// {{end}}
func (s signatureWorkflowORMDo) DeleteInBatch(ids []uint64) (err error) {
	var params []interface{}
