...
__export(src_exports, {
  ...
  D1CreateEndpoint: () => D1CreateEndpoint,
  D1DeleteEndpoint: () => D1DeleteEndpoint,
  D1ListEndpoint: () => D1ListEndpoint,
  D1ReadEndpoint: () => D1ReadEndpoint,
  D1UpdateEndpoint: () => D1UpdateEndpoint,
  DateOnly: () => DateOnly,
  DateTime: () => DateTime,
...
var OpenAPIHandler = class {
  ...
  getGeneratedSchema() {
    ...
    if (this.options?.openapiVersion === "3") openapiGenerator = import_zod_to_openapi2.OpenApiGeneratorV3;
...
var contentJson = (schema) => ({
  content: {
    "application/json": {
      schema: schema instanceof import_zod3.z.ZodType ? schema : legacyTypeIntoZod(schema)
    }
  }
});
...
// src/route.ts
(0, import_zod_to_openapi4.extendZodWithOpenApi)(import_zod4.z);
var OpenAPIRoute = class {
  ...
  async validateRequest(request) {
    ...
    let validationSchema = import_zod4.z.object(rawSchema);
...
var ListEndpoint = class extends OpenAPIRoute {
  ...
  getSchema() {
    ...
    if (this.searchFields) {
      parsedQueryParameters[this.searchFieldName] = import_zod5.z.string().optional().openapi({
        description: `Search by ${this.searchFields.join(", ")}`
      });
    }
    let queryParameters = import_zod5.z.object({
      page: import_zod5.z.number().int().min(1).optional().default(1),
      per_page: import_zod5.z.number().int().min(1).max(100).optional().default(20)
