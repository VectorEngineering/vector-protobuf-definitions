...
var OpenAPIRoute = class {
  ...
  async validateRequest(request) {
    ...
    let validationSchema = z4.object(rawSchema);
...
var ListEndpoint = class extends OpenAPIRoute {
  ...
  getSchema() {
    ...
    if (this.searchFields) {
      parsedQueryParameters[this.searchFieldName] = z5.string().optional().openapi({
        description: `Search by ${this.searchFields.join(", ")}`
      });
    }
    let queryParameters = z5.object({
      page: z5.number().int().min(1).optional().default(1),
      per_page: z5.number().int().min(1).max(100).optional().default(20)
