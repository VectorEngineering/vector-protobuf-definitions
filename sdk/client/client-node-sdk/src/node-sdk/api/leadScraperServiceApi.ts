...
export class LeadScraperServiceApi {
  ...
  public setApiKey(key: LeadScraperServiceApiApiKeys, value: string) {
    (this.authentications as any)[LeadScraperServiceApiApiKeys[key]].apiKey =
      value;
  }
  ...
  public async createAccount(
    ...
    const localVarPath =
      this.basePath + '/lead-scraper-microservice/api/v1/accounts';
   ...
   */
  public async createScrapingJob(
    createScrapingJobRequest: CreateScrapingJobRequest,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{
    response: http.IncomingMessage;
    body: CreateScrapingJobResponse;
  }> {
    const localVarPath =
      this.basePath + '/lead-scraper-microservice/api/v1/jobs';
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    ...
    if (
      createScrapingJobRequest === null ||
      createScrapingJobRequest === undefined
    ) {
      throw new Error(
  ...
  public async deleteAccount(
    ...
    const localVarPath =
      this.basePath +
      '/lead-scraper-microservice/api/v1/accounts/{accountId}'.replace(
        '{' + 'accountId' + '}',
   ...
   * @param tenantId
   */
  public async deleteScrapingJob(
    jobId: string,
    userId: string,
    orgId: string,
    tenantId: string,
    ...
    response: http.IncomingMessage;
    body: DeleteScrapingJobResponse;
  }> {
    const localVarPath =
      this.basePath +
      '/lead-scraper-microservice/api/v1/jobs/{jobId}'.replace(
        '{' + 'jobId' + '}',
   ...
   * @param tenantId
   */
  public async downloadScrapingResults(
    jobId: string,
    userId: string,
    orgId: string,
    tenantId: string,
    ...
    response: http.IncomingMessage;
    body: DownloadScrapingResultsResponse;
  }> {
    const localVarPath =
      this.basePath +
      '/lead-scraper-microservice/api/v1/jobs/{jobId}/download'.replace(
        '{' + 'jobId' + '}',
        encodeURIComponent(String(jobId))
      );
    let localVarQueryParameters: any = {};
   ...
   * @param tenantId
   */
  public async getScrapingJob(
    jobId: string,
    userId: string,
    orgId: string,
    tenantId: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: GetScrapingJobResponse }> {
    const localVarPath =
      this.basePath +
      '/lead-scraper-microservice/api/v1/jobs/{jobId}'.replace(
        '{' + 'jobId' + '}',
  ...
  public async updateAccount(
    ...
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: UpdateAccountResponse }> {
    const localVarPath =
      this.basePath + '/lead-scraper-microservice/api/v1/accounts';
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
