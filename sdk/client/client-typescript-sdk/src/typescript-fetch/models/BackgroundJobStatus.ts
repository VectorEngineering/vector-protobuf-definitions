...
export function instanceOfBackgroundJobStatus(value: any): boolean {
    for (const key in BackgroundJobStatus) {
        if (Object.prototype.hasOwnProperty.call(BackgroundJobStatus, key)) {
            if ((BackgroundJobStatus as Record<string, BackgroundJobStatus>)[key] === value) {
                return true;
            }
        }
    }
...
export function BackgroundJobStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): BackgroundJobStatus {
    return json as BackgroundJobStatus;
}

export function BackgroundJobStatusToJSON(value?: BackgroundJobStatus | null): any {
    return value as any;
}
