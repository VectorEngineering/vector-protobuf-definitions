 ...
 */
export function instanceOfCreateScrapingJobRequest(value: object): value is CreateScrapingJobRequest {
...
export function CreateScrapingJobRequestFromJSON(json: any): CreateScrapingJobRequest {
    return CreateScrapingJobRequestFromJSONTyped(json, false);
}

export function CreateScrapingJobRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateScrapingJobRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateScrapingJobRequestToJSON(value?: CreateScrapingJobRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
