...
// checks if the GatewayTimeoutErrorMessageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayTimeoutErrorMessageResponse{}
...
func NewGatewayTimeoutErrorMessageResponse() *GatewayTimeoutErrorMessageResponse {
	this := GatewayTimeoutErrorMessageResponse{}
	return &this
}
...
func (o GatewayTimeoutErrorMessageResponse) MarshalJSON() ([]byte, error) {
...
func (o GatewayTimeoutErrorMessageResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGatewayTimeoutErrorMessageResponse struct {
	value *GatewayTimeoutErrorMessageResponse
	isSet bool
}

func (v NullableGatewayTimeoutErrorMessageResponse) Get() *GatewayTimeoutErrorMessageResponse {
	return v.value
}

func (v *NullableGatewayTimeoutErrorMessageResponse) Set(val *GatewayTimeoutErrorMessageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayTimeoutErrorMessageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayTimeoutErrorMessageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayTimeoutErrorMessageResponse(val *GatewayTimeoutErrorMessageResponse) *NullableGatewayTimeoutErrorMessageResponse {
	return &NullableGatewayTimeoutErrorMessageResponse{value: val, isSet: true}
}

func (v NullableGatewayTimeoutErrorMessageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayTimeoutErrorMessageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
