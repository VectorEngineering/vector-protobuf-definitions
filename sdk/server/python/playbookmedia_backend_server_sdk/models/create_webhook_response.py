...
class CreateWebhookResponse(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CreateWebhookResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CreateWebhookResponse of this CreateWebhookResponse.  # noqa: E501
        :rtype: CreateWebhookResponse
        """
        return util.deserialize_model(dikt, cls)

    @property
    def webhook(self) -> WebhookConfig:
        """Gets the webhook of this CreateWebhookResponse.


        :return: The webhook of this CreateWebhookResponse.
        :rtype: WebhookConfig
        """
    ...
    def webhook(self, webhook: WebhookConfig):
        ...
        :param webhook: The webhook of this CreateWebhookResponse.
        :type webhook: WebhookConfig
        """
