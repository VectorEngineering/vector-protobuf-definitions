...
export const completionConfigs = {
     ...
     */
    chat: {
        systemPrompt: "You are a helpful AI assistant. Respond in a friendly and concise manner.",
        defaultModel: "@cf/mistral/7b-instruct-v0.2",
        defaultParams: {
            temperature: 0.7,
            maxTokens: 1000,
     ...
     */
    code: {
        systemPrompt: "You are an expert programmer. Provide clear, well-documented code with explanations.",
     ...
     */
    math: {
        systemPrompt: "You are a mathematics expert. Show your work and explain each step clearly.",
