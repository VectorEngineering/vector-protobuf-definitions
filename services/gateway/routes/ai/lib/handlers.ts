...
export const convertHandler = createCompletionHandler({
  systemPrompt:
    "You are an expert at converting HTML to clean, well-formatted markdown. Follow these rules:\n" +
...
export const enrichHandler = createCompletionHandler({
  systemPrompt:
    "You are an expert at analyzing web content and providing enriched context. For each piece of content:\n" +
...
export const summaryHandler = createCompletionHandler({
  systemPrompt:
    "You are an expert at creating concise, informative summaries. For each piece of content:\n" +
...
export const structureHandler = createCompletionHandler({
  systemPrompt:
    "You are an expert at analyzing HTML structure and providing insights. For each document:\n" +
 ...
 */
export const embeddingHandler = async (
  c: any,
  input: { html: string; options?: { includeOriginalText?: boolean } },
) => {
  try {
