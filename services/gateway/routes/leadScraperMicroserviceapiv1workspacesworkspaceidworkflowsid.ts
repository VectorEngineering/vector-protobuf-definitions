...
router.get("/", async (c) => {
  ...
  const response = await client.getLeadScraperMicroserviceApiV1WorkspacesWorkspaceIdWorkflowsId(params);
...
export const leadScraperMicroserviceapiv1workspacesworkspaceidworkflowsidRouter = router; 