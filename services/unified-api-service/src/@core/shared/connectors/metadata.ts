...
export const CONNECTORS_METADATA: ProvidersConfig = {
  crm: {
    hubspot: {
      ...
      logoPath:
        'https://assets-global.website-files.com/6421a177cdeeaf3c6791b745/64d61202dd99e63d40d446f6_hubspot%20logo.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
    ...
    attio: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJWZsShi0G6mZ451MngEvQrmJ2JIGH-AF8JyFU-q-n3w&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
    ...
    zoho: {
      ...
      logoPath:
        'https://assets-global.website-files.com/64f68d43d25e5962af5f82dd/64f68d43d25e5962af5f9812_64ad8bbe47c78358489b29fc_645e3ccf636a8d659f320e25_Group%25252012.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
    ...
    freshsales: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/Mwgb5c2sVHGHoDlthAYPnMGekEOzsvMR5zotxskrl0erKTW-xpZbuIXn7AEIqvrRHQ',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    zendesk: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNKVceZGVM7PbARp_2bjdOICUxlpS5B29UYlurvh6Z2Q&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
    ...
    accelo: {
      urls: {
        ...
        authBaseUrl: (domain) =>
          `https://${domain}.api.accelo.com/oauth2/v0/authorize`,
        apiUrl: (domain) => `https://${domain}.api.accelo.com/api/v0`,
      },
      logoPath:
        'https://play-lh.googleusercontent.com/j63K2u8ZXukgPs8QPgyXfyoxuNBl_ST7gLx5DEFeczCTtM9e5JNpDjjBy32qLxFS7p0',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      options: {
    ...
    active_campaign: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSymrBOaXpQab_5RPRZfiOXU7h9dfsduGZeCaZZw59xJA&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    affinity: {
      ...
      logoPath:
        'https://media.licdn.com/dms/image/C4D0BAQFOaK6KXEYj_w/company-logo_200_200/0/1630489791871/project_affinity_logo?e=2147483647&v=beta&t=u8j-1u3nO2m6vqgT170WJMCJyFSDiLYS_VguYOllNMI',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      primaryColor: '#244CED',
    ...
    capsule: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjS3qFlJJbQ802nGEV9w2GEgmnAIgJj6JJxe14cH6Wuw&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    close: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEH77yPBUkStmoc1ZtgJS4XeBmQiaq_Q1vgF5oerOGbg&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
    ...
    copper: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVa1YDciibzviRJxGovqH4gNgPxpZUAHEz36Bwnj54uQ&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    insightly: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/EMobDJKabP1eY_63QHgPS_-TK3eRfxXaeOnERbcRaWAw573iaV74pXS9xOv997dRZtM',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    keap: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPYsWSMe9KVWgCIQ8fw-vBOnfTlZaSS6p_43ZhEIx51A&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    microsoftdynamicssales: {
      ...
      urls: {
        docsUrl: '',
        authBaseUrl: (orgName) =>
          `https://login.microsoftonline.com/common/oauth2/v2.0/authorize?resource=${orgName}`,
        apiUrl: `/api/data/v9.2`,
      },
      logoPath:
        'https://play-lh.googleusercontent.com/MC_Aoa7rlMjGtcgAdiLJGeIm3-kpVw7APQmQUrUZtXuoZokiqVOJqR-bTu7idJBD8g',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      primaryColor: '#516EE2',
    ...
    nutshell: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbCONyN9DCKfd4E8pzIdItl5VqPTEErpoEn9vHCgblRg&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    pipeliner: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/rK9Qv_w9C8Py_aLZdQQDobNdHWSG8KL4dj3cBBQLcimVu-ctxwujA4VE442lIpZ65AE',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    salesflare: {
      ...
      urls: {
        docsUrl:
          'https://api.salesflare.com/docs#section/Introduction/Getting-Started',
        apiUrl: 'https://api.salesflare.com',
      },
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTesqSVCSaCDrjedsKbepr14iJPySzUwrh7Fg9MhgKh9w&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    salesforce: {
      ...
      logoPath:
        'https://logos-world.net/wp-content/uploads/2020/10/Salesforce-Logo.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      authStrategy: {
    ...
    sugarcrm: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQftNERc1ImBHm8MXXuWdhQiFYwW-dXNcogRL1UV8JyHFQGY2BbsbpwKvERwKRB39RH6zw&usqp=CAU',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    teamleader: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTE99rDOwXdRYGET0oeSCqK2kB02slJxZtTeBC79pb8IQ&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    teamwork: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr6gYDMNagMEicBb4dhKz4BC1fQs72In45QF7Ls6-moA&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    vtiger: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcUYrYD8lnaFaDN93vwjHhksKJUG3rqlb1TCFC__oPBw&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    redtail: {
      ...
      logoPath:
        'https://pbs.twimg.com/profile_images/1247266546688249856/7TZh-Laf_400x400.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.api_key,
    ...
    wealthbox: {
      ...
      logoPath:
        'https://pbs.twimg.com/profile_images/1674874004027461632/zoKBfoA0_400x400.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
  ...
  ticketing: {
    front: {
      ...
      logoPath:
        'https://i.pinimg.com/originals/43/a2/43/43a24316bd773798c7638ad98521eb81.png',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
      },
      options: {
    ...
    zendesk: {
      ...
      urls: {
        ...
        authBaseUrl: (myDomain) =>
          `https://${myDomain}.zendesk.com/oauth/authorizations/new`,
      },
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNKVceZGVM7PbARp_2bjdOICUxlpS5B29UYlurvh6Z2Q&s',
      description:
    ...
    gorgias: {
      ...
      urls: {
        ...
        authBaseUrl: (domain) =>
          `https://${domain}.com/connections/gorgias/oauth/install`,
      },
      options: {
        company_subdomain: true,
      },
      logoPath:
        'https://x5h8w2v3.rocketcdn.me/wp-content/uploads/2020/09/FS-AFFI-00660Gorgias.png',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      authStrategy: {
        strategy: AuthStrategy.oauth2,
    ...
    jira: {
      scopes:
        'read:jira-work manage:jira-project manage:jira-configuration read:jira-user write:jira-work manage:jira-webhook manage:jira-data-provider offline_access',
      urls: {
    ...
    gitlab: {
      scopes:
        'api read_api read_user create_runner k8s_proxy read_repository write_repository sudo admin_mode read_service_ping openid profile email',
      urls: {
    ...
    clickup: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRewJj9y5yKzSCf-qGgjmdLagEhxfnlZ7TUsvukbfZaIg&s',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      authStrategy: {
    ...
    github: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqz0aID6B-InxK_03P7tCtqpXNXdawBcro67CyEE0I5g&s',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: true,
      authStrategy: {
    ...
    asana: {
      ...
      logoPath:
        'https://cdn.dribbble.com/users/2043665/screenshots/12080585/sunset_asana_logo_screenprint.png',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      authStrategy: {
    ...
    dixa: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOxBDw6TkTaxR4EUGI_lNBLl4BCpd3AzXnr30cU_VEaB0jHFh__fFZJHXPB1t-451Eno8&usqp=CAU',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      primaryColor: '#5644D8',
    ...
    helpscout: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/ejDdUZ3Ssup5cVeOdCknoc1BpQtU07f8gYy4VYRudfBatFsOvFuwYybhB_lpSi2rmr2j',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      authStrategy: {
    ...
    ironclad: {
      ...
      logoPath:
        'https://logosandtypes.com/wp-content/uploads/2023/03/Ironclad.png',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      authStrategy: {
    ...
    kustomer: {
      ...
      urls: {
        docsUrl:
          'https://developer.kustomer.com/kustomer-api-docs/reference/introduction',
    ...
    wrike: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/uh-GbLWEKoIefta2iNX0L0zUWA66YTjfJ4cBarNZWbc7mEzbKUWbWg8NjjrojgkFH5ni',
      description:
        'Sync & Create accounts, tickets, comments, attachments, contacts, tags, teams and users',
      active: false,
      options: {
  ...
  accounting: {
    ...
    clearbooks: {
      ...
      logoPath:
        'https://s3-eu-west-1.amazonaws.com/clearbooks-marketing/media-centre/MediaCentre/clear-books/CMYK/icon/clear-books-icon-cmyk.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    freeagent: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQU-fob0b9pBNQdm80usnYa2yWdagm3eeBDH-870vSmfg&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    moneybird: {
      ...
      logoPath:
        'https://play-lh.googleusercontent.com/xqHj2qyqNoC-lX3HGeR6VMjndoc931QiFX92RPnRm8ACDcGMoMR5JKj4wyvPe6ITY5s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    quickbooks: {
      ...
      logoPath:
        'https://media.licdn.com/dms/image/D4D12AQFduz3E6g6COg/article-cover_image-shrink_600_2000/0/1697053235030?e=2147483647&v=beta&t=c2Ia7g8fJ6wAHNlnogLV_Ii765HMqSw16HxgawsxmTw',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    xero: {
      ...
      logoPath:
        'https://upload.wikimedia.org/wikipedia/en/archive/9/9f/20171204173437%21Xero_software_logo.svg',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
  ...
  marketingautomation: {
    ...
    apollo: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM4trwPJLoj7tPkFYZG6TyMVzgCX1fn2zUyA&s',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      primaryColor: '#ffcf40',
    ...
    klaviyo: {
      scopes:
        'campaigns:read accounts:read events:read events:write profiles:read profiles:write webhooks:read webhooks:write lists:read templates:read',
      urls: {
      ...
      logoPath:
        'https://logosandtypes.com/wp-content/uploads/2022/04/Klaviyo.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      authStrategy: {
    ...
    brevo: {
      ...
      logoPath:
        'https://sbp-plugin-images.s3.eu-west-1.amazonaws.com/technologies526_65670ec92e038_brevo300.jpg',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: false,
      primaryColor: '#0B996F',
  ...
  filestorage: {
    ...
    onedrive: {
      scopes:
        'Files.Read.All offline_access openid User.Read.All Group.Read.All',
      urls: {
        docsUrl:
      ...
      logoPath:
        'https://logowik.com/content/uploads/images/4964-microsoft-onedrive-new.jpg',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      authStrategy: {
    ...
    dropbox: {
      ...
      logoPath:
        'https://cdn2.iconfinder.com/data/icons/metro-ui-dock/512/Dropbox.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      authStrategy: {
    ...
    sharepoint: {
      scopes:
        'Files.Read.All offline_access openid User.Read.All Group.Read.All Sites.Read.All Sites.ReadWrite.All',
      urls: {
        docsUrl:
          'https://learn.microsoft.com/en-us/graph/api/overview?view=graph-rest-1.0',
      ...
      logoPath:
        'https://pnghq.com/wp-content/uploads/pnghq.com-microsoft-sharepoint-logo-9.png',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      primaryColor: '#6EA5A8',
    ...
    box: {
      ...
      logoPath:
        'https://gdm-catalog-fmapi-prod.imgix.net/ProductLogo/95b201e8-845a-4064-a9b2-a8eb49d19ca3.png?w=128&h=128&fit=max&dpr=3&auto=format&q=50',
      description:
        'Sync & Create contacts, deals, companies, notes, engagements, stages, tasks and users',
      active: true,
      authStrategy: {
  ...
  ecommerce: {
    bigcommerce: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH_-bQ399xl-yfJYhbLraU-w0yWBcppLf8NA&s',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: false,
      primaryColor: '#000001',
      authStrategy: {
        strategy: AuthStrategy.api_key,
    ...
    squarespace: {
      scopes:
        'website.orders,website.orders.read,website.inventory,website.inventory.read,website.products,website.products.read',
      urls: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu9U-j_3EMYlKtu5dRaTl6ejitL2X6lz3pYg&s',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: true,
      authStrategy: {
    ...
    amazon: {
      ...
      logoPath:
        'https://cdn.vectorstock.com/i/500p/39/87/astana-kazakhstan-20-july-2020-amazon-icon-vector-34243987.jpg',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: true,
      options: {
    ...
    magento: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKRidZq3jXGYOIZ2X2EruCx0pFMkbsHineLg&s',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: false,
      authStrategy: {
    ...
    webflow: {
      scopes:
        'ecommerce:read ecommerce:write users:read authorized_user:read sites:read',
      urls: {
        docsUrl:
      ...
      logoPath:
        'https://dailybrand.co.zw/wp-content/uploads/2023/10/webflow-2.png',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: true,
      authStrategy: {
    ...
    faire: {
      scopes:
        'READ_PRODUCTS WRITE_PRODUCTS READ_ORDERS WRITE_ORDERS READ_INVENTORIES WRITE_INVENTORIES',
      urls: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSDg6WOKCYRvGFmwtaJ6Gv88PjAGRS9_h9EQ&s',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: false,
      authStrategy: {
    ...
    woocommerce: {
      ...
      logoPath:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHiusc7S5-BoiU1YKCztJMv_Qj7wlim4TwbA&s',
      description:
        'Sync & Create orders, fulfillments, fulfillment orders, customers and products',
      active: true,
      primaryColor: '#702963',
