...
} from '@crm/engagement/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesTaskInput,
  MicrosoftdynamicssalesTaskOutput,
} from '@crm/task/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesNoteInput,
  MicrosoftdynamicssalesNoteOutput,
} from '@crm/note/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesDealInput,
  MicrosoftdynamicssalesDealOutput,
} from '@crm/deal/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesContactInput,
  MicrosoftdynamicssalesContactOutput,
} from '@crm/contact/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesCompanyInput,
  MicrosoftdynamicssalesCompanyOutput,
} from '@crm/company/services/microsoftdynamicssales/types';

import {
  MicrosoftdynamicssalesUserInput,
  MicrosoftdynamicssalesUserOutput,
} from '@crm/user/services/microsoftdynamicssales/types';
...
} from '@crm/contact/services/salesforce/types';
import {
  SalesforceDealInput,
  SalesforceDealOutput,
} from '@crm/deal/services/salesforce/types';
import {
  SalesforceCompanyInput,
  SalesforceCompanyOutput,
} from '@crm/company/services/salesforce/types';
import {
  SalesforceNoteInput,
  SalesforceNoteOutput,
} from '@crm/note/services/salesforce/types';
import { SalesforceTaskInput } from '@crm/task/services/salesforce/types';
import {
  SalesforceUserInput,
  SalesforceUserOutput,
} from '@crm/user/services/salesforce/types';
