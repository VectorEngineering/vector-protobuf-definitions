...
export type MicrosoftdynamicssalesEngagementCallInput =
  Partial<MicrosoftdynamicssalesPhoneCall>;
export type MicrosoftdynamicssalesEngagementCallOutput =
  MicrosoftdynamicssalesEngagementCallInput;

export type MicrosoftdynamicssalesEngagementEmailInput =
  Partial<MicrosoftdynamicssalesEmail>;
export type MicrosoftdynamicssalesEngagementEmailOutput =
  MicrosoftdynamicssalesEngagementEmailInput;

export type MicrosoftdynamicssalesEngagementAppointmentInput =
  Partial<MicrosoftdynamicssalesAppointment>;
export type MicrosoftdynamicssalesEngagementAppointmentOutput =
  MicrosoftdynamicssalesEngagementAppointmentInput;

export type MicrosoftdynamicssalesEngagementInput =
  | MicrosoftdynamicssalesEngagementCallInput
  | MicrosoftdynamicssalesEngagementEmailInput
  | MicrosoftdynamicssalesEngagementAppointmentInput;

export type MicrosoftdynamicssalesEngagementOutput =
