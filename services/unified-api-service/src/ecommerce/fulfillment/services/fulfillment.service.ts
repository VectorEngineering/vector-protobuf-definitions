...
export class FulfillmentService {
  ...
  async getFulfillments(
    ...
    try {
      ...
      const UnifiedEcommerceFulfillments: UnifiedEcommerceFulfillmentOutput[] =
        await Promise.all(
      ...
      let res: UnifiedEcommerceFulfillmentOutput[] =
        UnifiedEcommerceFulfillments;

      if (remote_data) {
        const remote_array_data: UnifiedEcommerceFulfillmentOutput[] =
          await Promise.all(
